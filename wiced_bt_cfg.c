 ...
 ****************************************************************************/
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =               /* Please do not change the name wiced_bt_cfg_settings since it is also used in HomeKit library */
{
    (uint8_t *)"LE Light",                                          /**< Local device name (NULL terminated) */
    ...
    /* BLE advertisement settings */
    {
        ...
        32,                                                         /**< Apple HAT spec requires 20msec high duty for 5 seconds */
        32,
        5,

        512,                                                       /**< Low duty undirected connectable minimum advertising interval */
        512,                                                       /**< Low duty undirected connectable maximum advertising interval */
    ...
    {
        0,                                                          /**< Maximum number of simultaneous RFCOMM connections */
...
const wiced_bt_cfg_buf_pool_t wiced_bt_cfg_buf_pools[] =
{
    ...
    { 720,      8   },      /* Large Buffer Pool  (used for HCI ACL messages) */
